...
{
	internal class PrescriptionJSONIListConverter : JsonConverter
	{
		internal static IPrescriptionRepository Repo { get; set; }

		public PrescriptionJSONIListConverter()
		{
		...
		{
			var writableList = ((IList<Prescription>)value).Select(ing => ing.Id);
