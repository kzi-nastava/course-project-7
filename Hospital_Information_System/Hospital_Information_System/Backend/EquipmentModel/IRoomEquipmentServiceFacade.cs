...
namespace HospitalIS.Backend.EquipmentModel
{
	...
	internal class RoomEquipmentServiceFacade : IEquipmentService
	{
		private readonly IEquipmentService _equipmentService;
		private readonly IRoomService _roomService;

		public RoomEquipmentServiceFacade(IEquipmentService equipmentService, IRoomService roomService)
		{
